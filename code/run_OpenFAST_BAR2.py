...
if MPI:
    ...
    iec.mpi_run               = False
iec.run_dir = 'outputs/OpenFAST_BAR2'
...
if rank == 0:
    ...
    if eagle:
        ...
        fastBatch.FAST_InputFile = 'BAR2.fst'   # FAST input file (ext=.fst)
        fastBatch.FAST_directory = '/home/pbortolo/BAR_Designs/BAR2/OpenFAST'   # Path to fst directory files
    else:
        ...
        fastBatch.FAST_directory = '/Users/pbortolo/work/2_openfast/BAR/OpenFAST_Models/BAR_02'   # Path to fst directory files
