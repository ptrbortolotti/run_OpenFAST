...
if MPI:
    ...
    iec.mpi_run               = False
iec.run_dir = 'outputs/OpenFAST_BAR02'
...
if rank == 0:
    ...
    if eagle:
        ...
        fastBatch.FAST_directory = '/home/pbortolo/wisdem_1_0_0/BAR/OpenFAST_Models/BAR_02'   # Path to fst directory files
    else:
