...
if __name__=="__main__":
    ...
    iec.init_cond[("ElastoDyn","RotSpeed")] = {'U':[3., 5.]}
    iec.init_cond[("ElastoDyn","RotSpeed")]['val'] = [6.972, 7.183]
    iec.init_cond[("ElastoDyn","BlPitch1")] = {'U':[3., 5.]}
    iec.init_cond[("ElastoDyn","BlPitch1")]['val'] = [0., 0.]
